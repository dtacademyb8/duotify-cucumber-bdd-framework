...
public class TestVideoGameDBPositive {
...
//                header("Content-Type", "application/json").
        ...
        // send a get request with the same id to verify the creation
...
//                get("/videogames/5").
        ...
        // send a put request with the same id to update the video game
        ...
        // send a get request with the same id to verify the update
...
//                get("/videogames/5").
        ...
        // send a delete request with the same id to remove the video game
